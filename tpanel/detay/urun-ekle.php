					...
					<div class="main-body">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
									     <h6 class="mb-0 text-uppercase">Ürün Bilgileri   </h6>
									    <hr>
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Sırası</h6>
											</div>
											<div class="col-sm-9 text-secondary">
											    <?php if($_GET['islem']!='duzenle'){?>
											    <input type="hidden" value="../urun-ekle" name="link">
											    <?php } else {?>
											    <input type="hidden" value="../urun-listele" name="link">
											    <?php }?>
								...
								<?php 
									$urunkategoricek5=$db->query("select * from urun_kategori order by id desc")->fetchAll(PDO::FETCH_ASSOC);
								foreach($urunkategoricek5 as $urunkat){?>
								...
								<?php }?>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9 text-secondary">
												<input type="text" class="form-control" name="fiyat" value="<?=$urun['fiyat']?>"/>
											</div>
										</div>
										
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Anahtar Kelimeler  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
											...
											<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Ön Açıklama  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<br><br>
										...
										<div class="row">
											...
											<?php if($_GET['islem']!='duzenle'){?>
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="urun-ekle" value="Ürün Ekle " />
											</div>
											<?php } else{?>
											<input type="hidden" name="id" value="<?=$_GET['id']?>">
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="urun-guncelle" value="Ürün Güncelle " />
											</div>
											<?php }?>
								...
								<div class="card">
									<div class="card-body">
									    <h6 class="mb-0 text-uppercase">Ürün Açıklama & Fotoğraflar  </h6>
									    <hr>
											<div class="row mb-3">
