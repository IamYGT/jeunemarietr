	...
	if($_GET['islem']=='duzenle'){
	    $id = $_GET['id'];
	    $urun=$db->query("select * from ekibimiz where id='$id'")->fetch(PDO::FETCH_ASSOC);
	}
	?>
					...
					<div class="main-body">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
									     <h6 class="mb-0 text-uppercase">Ekip Bilgileri   </h6>
									    <hr>
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ekip Sırası</h6>
											</div>
											<div class="col-sm-9 text-secondary">
											    <?php if($_GET['islem']!='duzenle'){?>
											    <input type="hidden" value="../ekibimiz-ekle" name="link">
											    <?php } else {?>
											    <input type="hidden" value="../ekibimiz-listele" name="link">
											    <?php }?>
										...
										<div class="row mb-3">
											...
											<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ekip Ön Açıklama  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<br><br>
										...
										<div class="row">
											...
											<?php if($_GET['islem']!='duzenle'){?>
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="ekip-ekle" value="Ekip Ekle " />
											</div>
											<?php } else{?>
											<input type="hidden" name="id" value="<?=$_GET['id']?>">
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="ekip-guncelle" value="Ekip Güncelle " />
											</div>
											<?php }?>
								...
								<div class="card">
									<div class="card-body">
									    <h6 class="mb-0 text-uppercase">Ekip Açıklama & Fotoğraflar  </h6>
									    <hr>
											<div class="row mb-3">
                            	...
                            	<?php
									...
									$iddd=$_GET['id'];
									if($_GET['islem']=='duzenle'){
										$cek = $db->query("SELECT * FROM urun_img WHERE urun_id = '$iddd' and tur='ekibimiz' order by id asc", PDO::FETCH_ASSOC);
										if($cek->rowCount()){
											foreach( $cek as $c ){
                             ...
                             <div class="col-md-4 " style="margin:auto;padding:auto;">
				                    <div class="uploaddis aktif" data-id="1" style="margin:0 auto;">
				        			  <div class="upload1">
				        				  <span class="metin" style="width: 100%;float: left;">Ekip Resimi Yükle</span>
