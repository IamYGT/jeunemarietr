					...
					<div class="main-body">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
									     <h6 class="mb-0 text-uppercase">Ürün Kategori Bilgileri   </h6>
									    <hr>
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Kategori Sırası</h6>
											</div>
											<div class="col-sm-9 text-secondary">
											    <?php if($_GET['islem']!='duzenle'){?>
											    <input type="hidden" value="../urun-kategori-ekle" name="link">
											    <?php } else {?>
											    <input type="hidden" value="../urun-kategori-listele" name="link">
											    <?php }?>
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Kategori Adı </h6>
											</div>
											<div class="col-sm-9 text-secondary">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Kategorisi </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<?php foreach($urunkategoricek as $urunkat){?>
								...
								<?php }?>
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Kategori Linki  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Kategori Anahtar Kelimeler  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
											...
											<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Ürün Kategori Ön Açıklama  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<br><br>
										...
										<div class="row">
											...
											<?php if($_GET['islem']!='duzenle'){?>
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="urun-kategori-ekle" value="Ürün Kategori Ekle " />
											</div>
											<?php } else{?>
											<input type="hidden" name="id" value="<?=$_GET['id']?>">
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="urun-kategori-guncelle" value="Ürün Kategori Güncelle " />
											</div>
											<?php }?>
								...
								<div class="card">
									<div class="card-body">
									    <h6 class="mb-0 text-uppercase">Ürün Kategori Açıklama</h6>
									    <hr>
											<div class="row mb-3">
