...
?>
<br><br>
<a href="sss-ekle" class="btn btn-outline-secondary px-5"><i class="bx bx-plus mr-1"></i>SSS Ekle</a>
<br><br>
	<div class="card">
					<div class="card-body">
									...
									<tr>
										...
										<td><div class="dropdown">
											...
											<ul class="dropdown-menu" style="">
												<li><a class="dropdown-item" href="sss-ekle?islem=duzenle&id=<?=$urun['id']?>">Düzenle</a>
												</li>
