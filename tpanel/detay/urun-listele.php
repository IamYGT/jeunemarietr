...
?>
<br><br>
<a href="urun-ekle" class="btn btn-outline-secondary px-5"><i class="bx bx-plus mr-1"></i>Ürün Ekle</a>
<br><br>
	<div class="card">
					<div class="card-body">
									...
									<tr>
										...
										<td><div class="dropdown">
											...
											<ul class="dropdown-menu" style="">
												<li><a class="dropdown-item" href="urun-ekle?islem=duzenle&id=<?=$urun['id']?>">Düzenle</a>
												</li>
