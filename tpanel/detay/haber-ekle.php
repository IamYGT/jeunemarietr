	...
	if($_GET['islem']=='duzenle'){
	    $id = $_GET['id'];
	    $urun=$db->query("select * from haberler where id='$id'")->fetch(PDO::FETCH_ASSOC);
	}
	?>
					...
					<div class="main-body">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
									     <h6 class="mb-0 text-uppercase">Haber Bilgileri   </h6>
									    <hr>
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Sırası</h6>
											</div>
											<div class="col-sm-9 text-secondary">
											    <?php if($_GET['islem']!='duzenle'){?>
											    <input type="hidden" value="../haber-ekle" name="link">
											    <?php } else {?>
											    <input type="hidden" value="../haber-listele" name="link">
											    <?php }?>
								...
								<?php }?>
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Anahtar Kelimeler  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
											...
											<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Ön Açıklama  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<br><br>
										...
										<div class="row">
											...
											<?php if($_GET['islem']!='duzenle'){?>
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="haber-ekle" value="Haber Ekle " />
											</div>
											<?php } else{?>
											<input type="hidden" name="id" value="<?=$_GET['id']?>">
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="haber-guncelle" value="Haber Güncelle " />
											</div>
											<?php }?>
								...
								<div class="card">
									<div class="card-body">
									    <h6 class="mb-0 text-uppercase">Haber Açıklama & Fotoğraflar  </h6>
									    <hr>
											<div class="row mb-3">
