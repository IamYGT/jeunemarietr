	...
	if($_GET['islem']=='duzenle'){
	    $id = $_GET['id'];
	    $urun=$db->query("select * from urun_kategori where id='$id'")->fetch(PDO::FETCH_ASSOC);
	}
	?>
					...
					<div class="main-body">
						...
						<div class="row">
							...
							<div class="col-lg-8">
								<div class="card">
									<div class="card-body">
									     <h6 class="mb-0 text-uppercase">Haber Kategori Bilgileri   </h6>
									    <hr>
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Kategori Sırası</h6>
											</div>
											<div class="col-sm-9 text-secondary">
											    <?php if($_GET['islem']!='duzenle'){?>
											    <input type="hidden" value="../haber-kategori-ekle" name="link">
											    <?php } else {?>
											    <input type="hidden" value="../haber-kategori-listele" name="link">
											    <?php }?>
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Kategori Adı </h6>
											</div>
											<div class="col-sm-9 text-secondary">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Kategorisi </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<?php foreach($haberkategoricek as $urunkat){?>
								...
								<?php }?>
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Kategori Linki  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Kategori Anahtar Kelimeler  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
											...
											<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">Haber Kategori Ön Açıklama  </h6>
											</div>
											<div class="col-sm-9 text-secondary">
								...
								<br><br>
										...
										<div class="row">
											...
											<?php if($_GET['islem']!='duzenle'){?>
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="haber-kategori-ekle" value="Haber Kategori Ekle " />
											</div>
											<?php } else{?>
											<input type="hidden" name="id" value="<?=$_GET['id']?>">
											<div class="col-sm-9 text-secondary">
												<input type="submit" class="btn btn-primary px-4" name="haber-kategori-guncelle" value="Haber Kategori Güncelle " />
											</div>
											<?php }?>
								...
								<div class="card">
									<div class="card-body">
									    <h6 class="mb-0 text-uppercase">Haber Kategori Açıklama</h6>
									    <hr>
											<div class="row mb-3">
